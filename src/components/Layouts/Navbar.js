    ...
    return (
        ...
        >
            <Flex
                ...
                alignItems={'center'}
            >
                <Heading as='h3' ml={{ base: 0, sm: 8 }} size='lg' fontWeight={'thin'} color='blue.500' style={{ fontFamily: "Pacifico" }}>BuildResume</Heading>
                <Spacer></Spacer>
                <HStack spacing={10} mr={{ base: 0, sm: 8 }} as='nav' style={{ fontFamily: 'Poppins' }}>
                    ...
                    <Button colorScheme={'blue'} fontWeight={'medium'}>Contact</Button>
                </HStack>
            </Flex>
